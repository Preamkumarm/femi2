...
const AddressModal = ({ isOpen, onClose, user, sizes, quantity, price, name }) => {
  ...
  const handleOrder = async () => {
    try {
      ...
      console.log("User order reference:", userOrderRef);
    
      const ordersRef = collection(db, "orders");
      console.log("Orders collection reference:", ordersRef);
    
      const userOrderSnap = await getDoc(userOrderRef);
      console.log("Fetched user order snapshot:", userOrderSnap.exists());
      ...
      console.log("New document reference ID:", docRef.id);
      ...
      if (userOrderSnap.exists()) {
        ...
        console.log("User orders set successfully.");
      }
